              ...
              $.fn.dataTable.ext.errMode = 'throw';
                $('#mydatatable').DataTable().destroy();
                  var table = $('#mydatatable').DataTable({
                      // OPTIONS
                      @include('admin.user.user.js.datatable-options')
                       ajax: 'requests/search-request-list-datatable/'+fecha_inicio+'/'+fecha_fin+'/'+id+'/'+cliente+'/'+dni+'/'+glm+'/'+poliza+'/'+fecha,
                      // COLUMNAS
                      @include('admin.user.user.js.datatable-columns')
                  }); 
