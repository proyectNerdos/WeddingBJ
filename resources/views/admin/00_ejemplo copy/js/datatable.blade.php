...
var table;
var baseUrlShow = "{{ route('cashflow.categories.show', ['cashFlowCategory' => 'tempId']) }}";
var baseUrlEdit = "{{ route('cashflow.categories.edit', ['cashFlowCategory' => 'tempId']) }}";
var baseUrlDelete = "{{ route('cashflow.categories.destroy', ['cashFlowCategory' => 'tempId']) }}";
...
function activartabla() {
    ...
    table = $('#datatable').DataTable({
        ...
        /*============================AJAX============================*/
        ajax: "{{ route('cashflow.categories.indexDatatable') }}",
        /*============================AJAX============================*/
