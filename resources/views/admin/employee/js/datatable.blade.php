...
var table;
var baseUrlShow = "{{ route('admin.employee.show', ['employee' => 'tempId']) }}";
var baseUrlEdit = "{{ route('admin.employee.edit', ['employee' => 'tempId']) }}";
var baseUrlDelete = "{{ route('admin.employee.destroy', ['employee' => 'tempId']) }}";
...
function activartabla() {
    ...
    table = $('#datatable').DataTable({
        ...
        /*============================AJAX============================*/
        ajax: "{{ route('admin.employee.indexDatatable') }}",
        /*============================AJAX============================*/
...
function ModalShow(uuid) {
    ...
    $.get(url, function(data) {
        ...
        $('#lastname_show').text(data.lastname);
