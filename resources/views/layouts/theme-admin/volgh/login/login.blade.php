...
<html lang="en" dir="ltr">
    ...
    <body class="login-img">
		...
		<div class="login-img" style="background-image: url('{{ asset('theme-admin/volgh/assets/images/login/wallpapertrigo.jpg') }}'); background-size: cover; background-position: center; width: 100vw; height: 100vh;">
						...
						<div class="wrap-login100 p-6">
                            <div class="col col-login mx-auto">
                                <div class="text-center">
                                    <img src="{{ asset('theme-front/javiersanchez/images/loader.png') }}" class="header-brand-img" alt="" style="width: 25%; height: auto;">
							...
							<form class="login100-form validate-form" method="POST" action="{{ route('login.store') }}">
								...
								<div class="text-center pt-3">
									{{-- <p class="text-dark mb-0">No eres miembro?<a href="register.html" class="text-primary ml-1">Sign UP now</a></p> --}}
								</div>
