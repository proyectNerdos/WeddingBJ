...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Product Combos' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('product_combos.product_combos.update', $productCombos->id) }}" id="edit_product_combos_form" name="edit_product_combos_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
