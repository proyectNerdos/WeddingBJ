<footer class="wpo-site-footer">
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xs-12">
                    <p class="copy">
                        © 2024 Sitios Web Profesionales - Todos los derechos reservados
                      </p>
                      <p class="desing">
                        Website designed by
                        <a href="https://sebastianmaturana.com/" class="sm_site"
                          >Sebastian Maturana</a
                        >
                      </p>
    ...
    <div class="ft-shape-1">
        <img src="{{ asset('theme-front/casamiento/images/footer-shape-1.svg') }}" alt="">
    </div>
    <div class="ft-shape-2">
        <img src="{{ asset('theme-front/casamiento/images/footer-shape-2.svg') }}" alt="">
    </div>
</footer>
