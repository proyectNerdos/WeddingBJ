...
<div class="row"> 
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <select class="form-control" name="driver" >
                {{-- settingPaymet->driver selected --}}
                <option value="" >Seleccione un Driver</option>
                @if($settingPaymet->driver == "smtp")
                <option value="smtp" selected="">SMTP</option>
                <option value="imap" >imap</option>
                <option value="pop3" >pop3</option>
                @endif
                @if($settingPaymet->driver == "imap")
                <option value="smtp" >SMTP</option>
                <option value="imap" selected="">imap</option>
                <option value="pop3" >pop3</option>
                @endif
                @if($settingPaymet->driver == "pop3")
                <option value="smtp" >SMTP</option>
                <option value="imap" >imap</option>
            ...
            <div class="input-group input-icon right ">
              ...
              <select class="form-control" name="encryption" >
                <option value="">Seleccione una Encriptacion</option>
                    @if($settingPaymet->encryption == "ssl")
                      <option value="ssl" selected="">ssl</option>
                      <option value="tls" >tls</option>
                      <option value="" >sin encriptacion</option>
                    @endif

                    @if($settingPaymet->encryption == "tls")
                      <option value="ssl" >ssl</option>
                      <option value="tls" selected="">tls</option>
                      <option value="" >sin encriptacion</option>
                    @endif

                    @if($settingPaymet->encryption == "")
                      <option value="ssl">ssl</option>
                      <option value="tls">tls</option>
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <input type="text" name="host" class="form-control" placeholder="host" required="" value="{{$settingPaymet->host}}">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <input type="text" name="username" class="form-control" placeholder="username" required="" value="{{$settingPaymet->username}}">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <input type="text" name="password" class="form-control" placeholder="password" required="" value="{{$settingPaymet->password}}">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <input type="text" name="address" class="form-control" placeholder="address" required="" value="{{$settingPaymet->address}}">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-icon right ">
              ...
              <input type="text" name="name" class="form-control" placeholder="name" required="" value="{{$settingPaymet->name}}">
            </div>
          </div>
  ...
  <input type="text" name="uuid_edit" id="uuid_edit" hidden="" value="{{$settingPaymet->uuid}}">