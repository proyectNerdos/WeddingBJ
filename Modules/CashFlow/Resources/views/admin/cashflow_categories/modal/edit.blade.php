    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Editar Centro de Gasto</h4>
            ...
            <form id="editCategoryForm" action="{{ route('admin.cashflow.categories.update', ['cashFlowCategory' => '__id__']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
