...
var table;
var baseUrlShow = "{{ route('admin.cashflow.categories.show', ['cashFlowCategory' => 'tempId']) }}";
var baseUrlEdit = "{{ route('admin.cashflow.categories.edit', ['cashFlowCategory' => 'tempId']) }}";
var baseUrlDelete = "{{ route('admin.cashflow.categories.destroy', ['cashFlowCategory' => 'tempId']) }}";
var getSubCategoriesUrl = "{{ route('admin.cashflow.categories.getSubCategories', ['cashFlowCategory' => ':tempId']) }}";
...
function activartabla() {
    ...
    table = $('#datatable').DataTable({
        ...
        /*============================AJAX============================*/
        ajax: "{{ route('admin.cashflow.categories.indexDatatable') }}",
        /*============================AJAX============================*/
        ...
        columns: [
            ...
            //action
            {
                ...
                render: function(data, type, row) {
                    ...
                    @permission('cashflow-subcategory-create')
                    buttons += `
                    ...
                    @permission('cashflow-category-view')
                    buttons += `
                    ...
                    @permission('cashflow-category-edit')
                    buttons += `
                    ...
                    @permission('cashflow-category-delete')
                    buttons += `
                    ...
                    @permission('cashflow-subcategory-view')
                    buttons += `
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    @permission('cashflow-subcategory-edit')
...
function ModalEditSubCategory(uuid) {
    ...
    var baseUrlEditSubcategory = "{{ route('admin.cashflow.subcategories.edit', ['cashFlowSubCategory' => 'tempId']) }}";
    var url = baseUrlEditSubcategory.replace('tempId', uuid);
    url = url.replace('tempId', uuid);
    $.get(url, function(data) {
        console.log("matias",data)
        //guardamos el uuid en mi input hidden
